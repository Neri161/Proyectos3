        ...
        @if(session('direccion'))
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="CP" id="CP" readonly class="form-control" placeholder="CP" value="{{session('usuario')->nombre}}" required>
                </div>
                <div class="form-group col-md-8">
                    <label for="nombre">Calle: </label>
                    <input type="text" name="calle" id="calle" readonly class="form-control" placeholder="calle" value="{{session('usuario')->nombre}}" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="no_Interior" id="no_Interior" readonly class="form-control" placeholder="No. Interior" value="{{session('usuario')->nombre}}" required>
                </div>
                <div class="form-group col-md-3">
                    <label for="nombre">No. Exterior: </label>
                    <input type="text" name="no_Exterior" id="no_Exterior" readonly class="form-control" placeholder="No. Exterior" value="{{session('usuario')->nombre}}" required>
                </div>
                <div class="form-group col-6">
                    <label for="nombre">Telefono: </label>
                    <input type="text" name="telefono" id="telefono" readonly class="form-control" placeholder="Telefono" value="{{session('usuario')->nombre}}" required>
                </div>
            </div>
            <div class="form-group">
                <label for="nombre">Referencia: </label>
                <input type="text" name="referencia" id="referencia" readonly class="form-control" placeholder="Referencia" value="{{session('usuario')->nombre}}" required>
            </div>
        @endif
        ...
        @if(session('tarjeta'))
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="folio_Tarjeta" id="folio_Tarjeta" readonly class="form-control" placeholder="Folio de Tarjeta" value="{{session('usuario')->nombre}}" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-4">
                    <label for="nombre ">Fecha de Vencimiento: </label>
                    <input type="text" name="fech_Vencimineto" id="fech_Vencimiento" readonly class="form-control" placeholder="Fecha de Vencimiento" value="{{session('usuario')->nombre}}" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="nombre">Numero de Seguridad: </label>
                    <input type="text" name="noSeguridad" id="noSeguridad" readonly class="form-control" placeholder="Numero de Seguridad" value="{{session('usuario')->nombre}}" required>
                </div>
                <div class="form-group col-md-4">
                    <label for="nombre">Compañia: </label>
                    <input type="text" name="compania" id="compania" readonly class="form-control" placeholder="Compañia" value="{{session('usuario')->nombre}}" required>
                </div>
            </div>
        @endif
